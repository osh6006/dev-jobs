  ...
  return (
    <>
      <div className="flex h-[228px] w-full cursor-pointer flex-col rounded-xl bg-white px-8 transition-transform hover:scale-110 dark:bg-very_dark_blue">
        ...
        />
        <div className="mt-5 font-thin text-gray">1mo ago partTime</div>
        <div className="mt-3 text-h3 font-bold capitalize dark:text-white">
          Fullstack Developer
        </div>
        <div className="mt-3 font-thin text-gray">Crowdfund</div>
        <div className="mt-7 font-bold text-violet">New Zealand</div>
      </div>
    </>
  );
};
