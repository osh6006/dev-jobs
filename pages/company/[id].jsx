    ...
    <div>
      <section className="w-full px-5 tablet:px-10">
        ...
        <div className="mt-4 rounded-md bg-white py-10 px-5 dark:bg-very_dark_blue">
          ...
          <ul className="mt-10 list-disc break-words px-5 text-dark_grey marker:text-violet">
          ...
          <ul className="mt-10 list-decimal break-words px-5 text-dark_grey marker:text-violet">
            {data?.company?.requirements?.items?.map((element, i) => (
              <li className="" key={i}>
                {element}
              </li>
