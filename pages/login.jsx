...
const Login = () => {
  return (
    <div className="flex h-full w-full items-center px-[165px]">
          ...
          <div className="w-1/2">
            <form>
              <div className="mb-6">
                <input
                  type="text"
                  className="form-control text-xl text-gray-700 border-gray-300 focus:text-gray-700 focus:border-blue-600 m-0 block w-full rounded border border-solid bg-white bg-clip-padding px-4 py-2 font-normal transition ease-in-out focus:bg-white focus:outline-none"
